...
class PortItem(QGraphicsEllipseItem):
    ...
    def __init__(self, name, parent=None):
        QGraphicsEllipseItem.__init__(self, QRectF(-6, -6, 6.0, 6.0), parent)
...
class BlockItem(QGraphicsRectItem):
   ...
   """
    ...
    def __init__(self, name='Untitled'):
        ...
        self.setCursor(QCursor(QtCore.Qt.BusyCursor))
        # Label:
        ...
        self.inputs.append(PortItem('d', self))
        self.outputs = []
        self.outputs.append(PortItem('y', self))
        self.outputs.append(PortItem('z', self))
        # Update size:
        self.changeSize(w, h)
...
class EditorGraphicsView(QGraphicsView):
    ...
    """def contextMenuEvent(self, event):
        ...
        menu = EditorGraphicsView.ContextMenu()
        menu.exec_()
        #menu.addAction('Delete')
        #pa = menu.addAction('Parameters')
        # pa.triggered.connect(self.editParameters)
...
class DiagramScene(QGraphicsScene):
    ...
    def mouseMoveEvent(self, mouse_event):
        editor.sceneMouseMoveEvent(mouse_event)
        super(DiagramScene, self).mouseMoveEvent(mouse_event)

    def mouseReleaseEvent(self, mouse_event):
        editor.sceneMouseReleaseEvent(mouse_event)
